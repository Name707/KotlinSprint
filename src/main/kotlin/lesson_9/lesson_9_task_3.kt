...
Для примера возьмем рецепт омлета. Для одной порции нужно: яиц – 2шт., молока – 50 мл, сливочного масла – 15 гр.
 ...
 – модернизировать список таким образом, чтобы вывести в консоль сообщение
 с количеством нужных ингредиентов такого типа:
...
fun main() {
    ...
    val allIngredients = ingredientsForOneDish.map { it * numberOfServings}

     println("На [$numberOfServings] порций вам понадобится: " +
             "Яиц – ${allIngredients[0]}, " +
             "молока – ${allIngredients[1]}, " +
             "сливочного масла – ${allIngredients[2]}")
